...
var CLIENT_ID = localStorage.asanaClientId || 69052944526325;
var REDIRECT_URI = localStorage.asanaRedirectUri || 'https://mindsharelabs.com/boards/login.html';
...
function preBoardSetup() {
    ...
    var assigneeDialog = $('#assigneeDialog').dialog({
        ...
        open: function(e) {
            ...
            $(document).off('click').click(function(e) {
                closeOnOutsideClick(e, assigneeDialog, dialogContainer)
            });
        },
    });
    var cardDialog = $('.cardEditDialog').dialog({
        ...
        open: function(e) {
            var dialogContainer = $(this).parents('.ui-dialog')[ 0 ];
            $(document).off('click').click(function(e) {
                closeOnOutsideClick(e, cardDialog, dialogContainer)
            });
        },
